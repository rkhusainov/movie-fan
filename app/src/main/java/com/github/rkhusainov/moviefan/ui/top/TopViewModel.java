...
public class TopViewModel extends ViewModel {
    ...
    public TopViewModel(OnItemClickListener onItemClickListener, int viewType) {
    ...
    public void loadMovies() {
        mCompositeDisposable.add(ApiUtils.getApi().getTopMovies(Constants.LANGUAGE, Constants.REGION)
